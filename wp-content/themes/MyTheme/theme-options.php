		...
		<form method="post" action="options.php">
			...
			<table class="form-table">
				...
				<tr valign="top"><th scope="row"><?php _e( 'Телефон', 'sampletheme' ); ?></th>
					<td>
						<input id="sample_theme_options[phone_text]" class="regular-text" type="text" name="sample_theme_options[phone_text]" value="<?php esc_attr_e( $options['phone_text'] ); ?>" />
						<label class="description" for="sample_theme_options[phone_text]"></label>
					</td>
				</tr>
				<tr valign="top"><th scope="row"><?php _e( 'Адрес', 'sampletheme' ); ?></th>
					<td>
						<input id="sample_theme_options[adress_text]" class="regular-text" type="text" name="sample_theme_options[adress_text]" value="<?php esc_attr_e( $options['adress_text'] ); ?>" />
						<label class="description" for="sample_theme_options[adress_text]"></label>
					</td>
				</tr>
				<tr valign="top"><th scope="row"><?php _e( 'E-mail', 'sampletheme' ); ?></th>
					<td>
						<input id="sample_theme_options[email_text]" class="regular-text" type="text" name="sample_theme_options[email_text]" value="<?php esc_attr_e( $options['email_text'] ); ?>" />
						<label class="description" for="sample_theme_options[email_text]"></label>
					</td>
				</tr>
